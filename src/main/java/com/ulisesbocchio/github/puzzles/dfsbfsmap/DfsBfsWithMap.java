...
public class DfsBfsWithMap {
    public static boolean pathExistsDFS(Map<Integer, List<Integer>> graph, int a, int b) {
        return pathExistsDFSInternal(graph, new HashSet<>(), a, b);
    }

    private static boolean pathExistsDFSInternal(Map<Integer, List<Integer>> graph, Set<Integer> visited, int a, int b) {
        boolean found = false;
        if (a == b) {
            found = true;
    ...
    public static boolean pathExistsDFSIterative(Map<Integer, List<Integer>> graph, int a, int b) {
    ...
    public static boolean pathExistsBFS(Map<Integer, List<Integer>> graph, int a, int b) {
